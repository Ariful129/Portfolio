...
import image from '../../../assets/contact/illustration-light.svg'
import { FaHandsClapping, FaMailchimp } from "react-icons/fa6";
    ...
    <div className=' md:space-y-36'>
      ...
      <div className='flex md:flex-row md:items-center md:gap-80 mt-10'>
        ...
        <div className='text-left space-y-4'>
          ...
          <div>
            <h1 className='text-6xl font-bold mb-4'>Let's Work <br></br>Together.</h1>
            <p>Reach out today and let's turn your ideas into reality - your message matters to us.</p>
          </div>
        </div>
